...
class RedeemOrderMenuItems extends StatefulWidget {
  RedeemOrderMenuItems({Key? key, required this.orderId}) : super(key: key);
  int orderId;

  @override
  State<RedeemOrderMenuItems> createState() => _RedeemOrderMenuItemsState();
}

class _RedeemOrderMenuItemsState extends State<RedeemOrderMenuItems> {
  ...
  getMenuListApiCall() async {
    ...
    print('cart list==${orderViewModel.addToCartLocalData}');
                  ...
                  "menu": [
                    for (var i = 0;
                        ...
                        i++)
                      {
                        ...
                        'saving_price':
                            element.menuSubCategoryData![i].savingPrice
                      }
                  ],
                          ...
                          children: [
                            GestureDetector(
                                onTap: () {
                                  Get.to(RedeemOffer(
                                    isEditFlow: true,
                                    tackAwayOrderId: widget.orderId,
                                  ));
                                },
                                child: Container(
                                    width: 40.w,
                              ...
                              response == null ||
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        final qtyCount = (orderViewModel
                                                    .addToCartLocalData[
                                                'data']![index]['menu'] as List)
                                            .where((element) =>
                                                element['qty'] > 0);
                                        return Column(
                                          children: [
                                            Theme(
                                              ...
                                              child: ExpansionTile(
                                                  ...
                                                  initiallyExpanded:
                                                      qtyCount.isNotEmpty && qtyCount.single['qty'] > 0
                                                          ? true
                                                          : false,
                                                  ...
                                                  title: Text(data.name!,
                                                      style: const TextStyle(
                                                          ...
                                                          color: black_504f58)),
                                                  children:
                                                      response!.data![index].menuSubCategoryData ==
                                                                  [] ||
                                                              response!
                                                                  .data![index]
                                                                  .menuSubCategoryData!
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Row(
                                                                                          children: [
                                                                                            ...
                                                                                            Text("${orderViewModel.addToCartLocalData['data']![index]['menu']![i]['price']}", style: TextStyle(color: green_5cb85c, fontFamily: fontMavenProProSemiBold, fontSize: 15.sp), textAlign: TextAlign.right)
                                                                                          ],
                                                                                        ),
                                                                                      ],
                                                                                    ),
                                                                              ...
                                                                              orderViewModel.addToCartLocalData['data']![index]['menu']![i]['qty'] <= 0
                                                                                  ? InkWell(
                                                                                      onTap: () async {
                                                                                        ...
                                                                                        await orderViewModel.addToCart(subCategoryId: orderViewModel.addToCartLocalData['data']![index]['menu']![i]['id'], qty: orderViewModel.addToCartLocalData['data']![index]['menu']![i]['qty'], orderId: widget.orderId.toString());
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            // ₹15.53
                                            Text(
                                                "₹${orderViewModel.savingPriceCount()}",
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontFamily:
                                                        fontMavenProProSemiBold,
