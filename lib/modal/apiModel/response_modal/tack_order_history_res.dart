class TackAwayOrderHistoryResModel {
  bool? status;
  String? message;
  Data? data;

  TackAwayOrderHistoryResModel({this.status, this.message, this.data});

  TackAwayOrderHistoryResModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
