...
class OrderHistoryTakeawayTab extends StatefulWidget {
  const OrderHistoryTakeawayTab({Key? key}) : super(key: key);

  @override
  State<OrderHistoryTakeawayTab> createState() =>
      _OrderHistoryTakeawayTabState();
}

class _OrderHistoryTakeawayTabState extends State<OrderHistoryTakeawayTab> {
